    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                	<p><a href="examples/temas.csv"><span class="glyphicon glyphicon-file"></span> Plantilla Formato 1.csv</a> (por grupo)</p>
                    <p><a href="examples/temas2.csv"><span class="glyphicon glyphicon-file"></span> Plantilla Formato 2.csv</a> (por alumno)</p>
                </div>
            </div>         
        </div>
    </div>
